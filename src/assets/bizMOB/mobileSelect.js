		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			...
			_this.mobileSelect.innerHTML =
		        ...
		        '<div class="content">'+
		            ...
		            '</div>'+
		            '<div class="panel">'+
						'<div class="selectArea" style="position: absolute; top: 50%; left: 5%; background-color: #eeeeee; height: 40px; width: 90%; border-radius: 10px; margin-top: 1px;"></div>'+
		                '<div class="fixWidth">'+
		                	'<div class="wheels">'+
			                '</div>'+
