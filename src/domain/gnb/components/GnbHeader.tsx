...
import useAuth from '@/domain/user/hooks/queries/useAuth';
...
export const GnbHeader = ({}) => {
  ...
  const { accessToken, refreshToken, userInfo: getUserInfo } = useUserStore();
